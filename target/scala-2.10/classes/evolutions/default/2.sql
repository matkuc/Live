...
insert into team (id,name, crest) values (1,'Śląsk Wrocław', 'slaskwroclaw.gif');
insert into team (id,name, crest) values (2,'Legia Warszawa', 'legiawarsawa.gif');
insert into team (id,name, crest) values (3,'Wisła Kraków', 'wislakrakowa.gif');
insert into team (id,name, crest) values (4,'Ruch Chorzów', 'ruchchorzow.gif');
insert into team (id,name, crest) values (5,'Lechia Gdańsk', 'lechiagdansk.gif');
insert into team (id,name, crest) values (6,'Zawisza Bydgoszcz', 'zawiszabydgoszcz.gif');
insert into team (id,name, crest) values (7,'Lech Poznań', 'lechpoznan.gif');
insert into team (id,name, crest) values (8,'Jagiellonia Białystok', 'jagielloniabialystok.gif');
insert into team (id,name, crest) values (9,'Korona Kielce', 'koronakielce.gif');
insert into team (id,name, crest) values (10,'Podbeskidzie Bielsko-Biała', 'podbeskidzie.gif');
insert into team (id,name, crest) values (11,'Zagłebie Lubin', 'zaglebielubin.gif');
insert into team (id,name, crest) values (12,'Widzew Łódź', 'widzewlodz.gif');
insert into team (id,name, crest) values (13,'Cracovia', 'cracovia.gif');
insert into team (id,name, crest) values (14,'Pogoń Szczecin', 'pogonszczecin.gif');
insert into team (id,name, crest) values (15,'Górnik Zabrze', 'gornikzabrzegif');
insert into team (id,name, crest) values (16,'Piast Gliwice', 'piastgliwice.gif');

insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (1, 1, 'Mila', 'Sebastian', '1982-07-10', 1, 'mila.png', 178, 67, 'pomocnik', 11);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (2, 1, 'Kelemen', 'Marian', '1979-12-07', 1, 'kelemen.png', 188, 83, 'bramkarz', 25);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (3, 1, 'Ostrowski', 'Krzysztof', '1982-05-03', 1, 'ostrowski.png', 178, 73, 'obrońca', 16);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (4, 1, 'Pawelec', 'Mariusz', '1986-04-14', 1, 'pawelec.png', 180, 72, 'obrońca', 17);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (5, 1, 'Paraiba', 'Dudu', '1985-03-11', 1, 'paraiba.png', 181, 71, 'obrońca', 12);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (6, 1, 'Patejuk', 'Sylwester', '1982-11-30', 1, 'patejuk.png', 188, 80, 'pomocnik', 9);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (7, 1, 'Paixao', 'Flavio', '1984-09-19', 1, 'fpaixao.png', 184, 75, 'pomocnik', 28);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (8, 1, 'Hołota', 'Tomasz', '1991-01-27', 1, 'holota.png', 185, 83, 'pomocnik', 6);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (9, 1, 'Dankowski', 'Kamil', '1996-07-22', 1, 'dankowski.png', 177, 67, 'pomocnik', 30);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (10, 1, 'Machaj', 'Mateusz', '1989-06-26', 1, 'machaj.png', null, null, 'pomocnik', 8);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (11, 1, 'Pich', 'Robert', '1988-11-12', 1, 'pich.png', null, null, 'pomocnik', 27);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (12, 1, 'Paixao', 'Marco', '1984-09-19', 1, 'paixao.png', 185, 79, 'napastnik', 19);
insert into player (id, team_id, lastname, firstname, date_birth, status, photo, height, weight, position, number) values (13, 2, 'Kosecki', 'Jakub', '1990-08-29', 1, 'kosecki.png', 168, 59, 'pomocnik', null);

insert into match1 (id, result_a, result_b) values (1, 3, 3);
# --- !Downs
